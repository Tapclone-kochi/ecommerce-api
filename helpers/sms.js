...
module.exports.sendResetPasswordSMS = (number, resetCode) => {
  console.log("Dear Customer, your password reset link is http://localhost/nayana/reset-password.html?code=" + resetCode + " . Open the link to reset your password. Links are valid for 24 hrs. Regards! NAYANA");
}